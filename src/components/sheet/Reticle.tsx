// The Aim control — a scope reticle you arm, not a checkbox you tick.
//
// Same reasoning as the Grit cylinder: this is the right CONTROL as well
// as the right picture. Arming it is declaring intent ("I'm lining this
// one up"), so the reticle lights; the spend happens later, all at once,
// when the trigger goes — deduct-at-fire, as agreed, with the rare
// announced-then-aborted Aim left to the table and the steppers.
//
...
//            in the data (the cylinder's ↻ is the same signal).
  ...
  return (
    ...
    >
      <svg viewBox="0 0 40 40" className="h-9 w-9" aria-hidden>
        ...
        {armed && !spent && (
          <circle cx="20" cy="20" r="3" fill="var(--sheet-accent, #f59e0b)" />
        )}
